...
export default function Review({addressInfo, product, paymentInfo}) {
    const classes = useStyles();
    console.log("addressInfo", addressInfo)
    console.log("paymentInfo", paymentInfo)
    const {firstName, lastName, address1, address2, city, state, zip, country} = addressInfo  
    ...
    const payments = [{name: 'Card type', detail: 'Visa'},
                        ...
                        {name: 'Expire date', detail: expDate},
                    ]    
    return (
        <React.Fragment>
